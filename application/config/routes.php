...
| -------------------------------------------------------------------------
*/
$route['api/auth/(:any)'] = 'api/AuthController/$1';

$route['api/menu'] = 'api/MenuController/index';
$route['api/menu/(:any)/(:num)'] = 'api/MenuController/$1/$2';
$route['api/menu/(:any)'] = 'api/MenuController/$1';
